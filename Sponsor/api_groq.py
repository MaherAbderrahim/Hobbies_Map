...
def ameliorer_description(description_utilisateur: str) -> str:
    ...
    prompt = f"Dans le cadre d'une application, peux-tu améliorer cette description de sponsor qui doit être brève et concise ? Donne-moi juste la description finale en anglais sous forme de paragraphe, sans introduction ni explication : {description_utilisateur}"
